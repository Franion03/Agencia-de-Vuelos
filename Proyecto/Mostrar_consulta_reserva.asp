...
<div class="container">
	<%
		...
		Else	
			...
			response.write("<a href=http://localhost/Practica_DAI/Cancelar_reserva.asp?idreserva=" & id_reserve & "><input class='waves-effect waves-light btn' type=button value='Cancelar reserva'></a>")
		end if		
