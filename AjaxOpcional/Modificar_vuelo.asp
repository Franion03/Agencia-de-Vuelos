...
<div class="container">
	...
	<%
		response.write("<a href=http://localhost/Agencia-de-Vuelos/AjaxOpcional/Delete_planes.asp?id=" & datos("idavion") & "><input class='waves-effect waves-light btn' type=button value=Borrar></a>")
	%>
